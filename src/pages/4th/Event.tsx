  ...
  return (
    <div className="px-0 md:px-10 py-10 md:max-w-4xl m-auto">
      <TextSection title="REBIRTH N REVERSE">
        ...
        <p>
          제 4회 머지영화제 <span className="point">REBIRTH N REVERSE</span>는 3년 만에 재개되는 행사로, 말 그대로 '재탄생'과 '반전'을 주제로 합니다. 다양한 장르와 스타일의 작품들이 병합되는 순간을
          체험해보세요. 새롭게 시작하는 머지 영화제의 무한한 가능성을 함께 만나보시길 바랍니다.
        </p>
      </TextSection>

      <TextSection title="행사 정보">
        <ul>
          <li>- 시작: 2023년 9월 28일 15:00 (KST) ~ 2023년 9월 29일 (종료시간 미정)</li>
          <li>
